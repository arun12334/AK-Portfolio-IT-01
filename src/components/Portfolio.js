...
import { SiPostman, SiXcode, SiTypescript } from "react-icons/si";
    ...
    return (
      <section id="portfolio">
        ...
        <h2 className="tech-icons">  <DiReact /> </h2>
          ...
          <h2 className="tech-icons"> <SiTypescript /> </h2>
        ...
        <h2 className="tech-icons"> <SiXcode /> </h2>
        <h2 className="tech-icons"> <DiAndroid /> </h2>
